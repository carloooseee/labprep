...
export default function GeneralGuidelines() {
  ...
  useEffect(() => {
    ...
    if (guidelines.rulesFilipino || guidelines.dosFilipino || guidelines.dontsFilipino) {
      setTranslatedGuidelines({
        rules: guidelines.rulesFilipino || guidelines.rules,
        dos: guidelines.dosFilipino || guidelines.dos,
        donts: guidelines.dontsFilipino || guidelines.donts
      });
      return;
    }
